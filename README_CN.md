...
- 删除了对 `xorm.io/core` 的依赖。大部分代码迁移到了 `github.com/caeret/xorm/core`, `github.com/caeret/xorm/names`, `github.com/caeret/xorm/schemas` 等等几个包中.
...
* [Godoc代码文档](http://pkg.go.dev/github.com/caeret/xorm)
